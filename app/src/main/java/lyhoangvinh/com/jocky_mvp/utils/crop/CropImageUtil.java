...
public class CropImageUtil {
     ...
     */
    public static void startPickImageActivity(@NonNull Activity activity, @NonNull Integer strTitleChooser) {
        activity.startActivityForResult(getPickImageChooserIntent(activity, strTitleChooser), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
     ...
     */
    public static Intent getPickImageChooserIntent(@NonNull Context context, @NonNull Integer strTitleChooser) {
        return getPickImageChooserIntent(context, context.getString(strTitleChooser), false);
    }
    ...
    /**
     * Get the URI of the selected image from {getPickImageChooserIntent(Context)}.<br>
